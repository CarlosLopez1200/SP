...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Editar Peticion</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        {!! Form::model($peticiones, ['method' => 'PATCH','route' => ['Peticiones.update', $peticiones->id]]) !!}
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label for="Solicitante">Persona solicitante</label>
                                    {!! Form::text('Solicitante', null, array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
